...
from utils.general import non_max_suppression, make_divisible, scale_coords, xyxy2xywh, check_suffix, check_requirements
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov5s.pt', device=None, dnn=False, data=None, fuse=True):
        ...
        if pt:  # PyTorch
            model = attempt_load_prune(weights if isinstance(weights, list) else w, map_location=device, fuse=fuse)
